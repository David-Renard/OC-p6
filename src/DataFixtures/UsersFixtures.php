...
class UsersFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $usersAsArray =
            [
             ["firstname" => "Océane","name" => "Barbier","email" => "oceanebarb@hotmail.com","username" => "oceba","password" => "Ocean84-Barb",],
             ...
             ["firstname" => "Rose","name" => "Gillet","email" => "rgil@yahoo.fr","username" => "roseg","password" => "Ros88-Gill",],
             ...
             ["firstname" => "Florence","name" => "Bourgeois","email" => "florencbourgeo@yahoo.com","username" => "flob","password" => "Floren7>Bourgeo",],
             ["firstname" => "Aliyah","name" => "Poirier","email" => "apoir@yahoo.fr","username" => "alipoi","password" => "Aliya106<Poi",],
             ["firstname" => "Romy","name" => "Lemoine","email" => "romylemo@hotmail.com","username" => "romle","password" => "Rom8>Lemoin",],
             ["firstname" => "Rose","name" => "Colin","email" => "roseco@hotmail.fr","username" => "roco","password" => "Ros13<Colin",],
             ["firstname" => "Victor","name" => "Deschamps","email" => "victdeschamp@hotmail.com","username" => "vd","password" => "Vic19>Deschamp",],
             ...
             ["firstname" => "Ethan","name" => "Fournier","email" => "efournier@gmail.com","username" => "etf","password" => "Eth83?Fourni",],
